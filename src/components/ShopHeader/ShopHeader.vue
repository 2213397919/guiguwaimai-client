<template>
  <div class="shop-header">
    <nav class="shop-nav"
      ...
      <a class="back">
        <i class="iconfont icon-arrow_left" @click="$router.replace('/mysite')"/>
      </a>
    </nav>
<!--品牌-->
    <div class="shop-content" @click="isShowSupports=true">
...
<!--优惠-->
    <div class="shop-header-discounts" v-if="info.supports" @click="isShowBulletin=true">
    ...
    <transition name="fade">
      <div class="shop-brief-modal" style="display: none;" v-show="isShowSupports">
   ...
   <transition name="move">
     <div class="activity-sheet" style="display: none;" v-show="isShowBulletin">
       <div class="activity-sheet-content">
         <h2 class="activity-sheet-title">
           优惠活动</h2>
         <ul class="list">
           <li class="activity-item " :class="isSupportClass[support.type]" v-for="(support,index) in info.supports" :key="index">
            <span class="content-tag">
  ...
  export default {
    ...
    data(){
      return {
        ...
        isSupportClass: ['activity-green','activity-red', 'activity-orange']
      }
    },
    computed: {
      ...mapState({
